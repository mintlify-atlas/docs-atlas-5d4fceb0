...
<Tip>
You can also use `session.mcp.commands.claude` from the Composio dashboard or the MCP config API to get a pre-filled command you can paste directly into the config file.
</Tip>
