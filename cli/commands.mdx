---
title: "Composio CLI Commands: Flags, Options, and Examples"
sidebarTitle: "Commands"
description: "Full reference for Composio CLI commands: login, whoami, search, execute, link, proxy, run, upgrade, and more — with flags and usage examples."
---
...
# Connect a second Gmail account with an alias
...
Each result returned by `execute()` and `search()` has a `.prompt()` method that serializes it into a prompt-safe string, suitable for passing to `experimental_subAgent()`.
