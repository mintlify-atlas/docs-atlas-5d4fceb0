...
description: "The Composio CLI lets you search and execute tools, manage app connections, and run scripted workflows from your terminal — designed for use inside Claude Code."
---
