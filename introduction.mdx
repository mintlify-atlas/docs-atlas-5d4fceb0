...
description: "Composio connects AI agents to 1000+ tools and APIs with managed auth, per-user sessions, MCP endpoints, and provider adapters for every major AI framework."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Python" icon="python" href="/how-composio-works">
