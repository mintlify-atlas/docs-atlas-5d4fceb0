---
title: "Authenticating Composio API Requests"
sidebarTitle: "Authentication"
description: "Authenticate Composio API calls with your project API key. Pass it as x-api-key header or as a Bearer token in the Authorization header."
---
