---
title: "Composio REST API Overview"
sidebarTitle: "Overview"
description: "The Composio REST API provides programmatic access to tools, toolkits, connected accounts, auth configs, triggers, and more. Base URL: https://backend.composio.dev/api/v3.1"
---
