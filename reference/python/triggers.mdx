---
title: "Python SDK Triggers Reference — composio.triggers API"
sidebarTitle: "Triggers"
description: "composio.triggers streams real-time events from connected apps. Call subscribe() to listen and create() to set up persistent trigger instances."
---
