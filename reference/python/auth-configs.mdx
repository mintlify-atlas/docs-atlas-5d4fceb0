---
title: "Auth Configs — Composio Python SDK Reference Guide"
sidebarTitle: "Auth Configs"
description: "composio.auth_configs creates and manages custom OAuth apps, API key configs, and auth settings. Every connected account links to an auth config."
---
