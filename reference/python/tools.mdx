---
title: "Composio Python SDK Tools Reference — get and execute"
sidebarTitle: "Tools"
description: "composio.tools provides get() to fetch provider-wrapped schemas and execute() to run tools. Use modifiers to transform inputs, outputs, and schemas."
---
