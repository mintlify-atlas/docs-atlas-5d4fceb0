---
title: "ConnectedAccounts — Composio Python SDK Reference"
sidebarTitle: "Connected Accounts"
description: "composio.connected_accounts manages user OAuth connections and API key auth. Use link() to start OAuth flows and list() to query existing connections."
---
