...
description: "experimental_createTool() and experimental_createToolkit() define custom TypeScript tools that work alongside Composio's built-in integrations in sessions."
---
