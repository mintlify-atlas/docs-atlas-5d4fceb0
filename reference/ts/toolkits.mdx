...
description: "composio.toolkits provides list() and get() to discover Composio's 1000+ toolkit integrations and inspect available tools, auth schemes, and metadata."
---
