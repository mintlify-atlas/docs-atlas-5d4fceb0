...
description: "composio.triggers subscribes to real-time webhook events from connected apps. React to new emails, GitHub events, Slack messages, and other app activity."
---
