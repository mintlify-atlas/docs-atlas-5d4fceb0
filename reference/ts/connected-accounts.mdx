...
description: "composio.connectedAccounts manages user connections to external apps. Use initiate() to start OAuth flows, list() to query connections, and waitForConnection() to confirm."
---
